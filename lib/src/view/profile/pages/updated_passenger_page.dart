...
class UpdatedPassengerPage extends StatefulWidget {
  final UsersModel usersModel;
  const UpdatedPassengerPage({super.key, required this.usersModel});
  static const String routeName = "/updatedPassenger";

  @override
  State<UpdatedPassengerPage> createState() => _UpdatedPassengerPageState();
}

class _UpdatedPassengerPageState extends State<UpdatedPassengerPage> {
  ...
  void initState() {
    ...
    final user = widget.usersModel;

    // Dastlabki qiymatlarni controllerlarga yuklash
    controllers.firstnameController.text = user.firstname ?? "";
    controllers.lastnameController.text = user.lastname ?? "";
    controllers.middlenameController.text = user.middlename ?? "";
    controllers.docnumController.text = user.docnum ?? "";
    controllers.birthdateController.text = user.birthdate ?? "";
    controllers.docexpController.text = user.docexp ?? "";
    gender = user.gender ?? "M";

    if ((user.citizen ?? "").isNotEmpty) {
      final fetchedCountry = getCountry(user.citizen!);
    ...
    controllers.firstnameController.addListener(_checkForChanges);
    controllers.lastnameController.addListener(_checkForChanges);
    controllers.middlenameController.addListener(_checkForChanges);
    controllers.birthdateController.addListener(_checkForChanges);
    controllers.docnumController.addListener(_checkForChanges);
    controllers.docexpController.addListener(_checkForChanges);
  }
  ...
  void _checkForChanges() {
    final currentData = {
      ...
      "middlename": controllers.middlenameController.text.trim(),
      "birthdate": controllers.birthdateController.text.trim(),
      "docnum": controllers.docnumController.text.trim(),
      "docexp": controllers.docexpController.text.trim(),
      "gender": gender,
  ...
  @override
  void dispose() {
    controllers.firstnameController.removeListener(_checkForChanges);
    controllers.lastnameController.removeListener(_checkForChanges);
    controllers.middlenameController.removeListener(_checkForChanges);
    controllers.birthdateController.removeListener(_checkForChanges);
    controllers.docnumController.removeListener(_checkForChanges);
    controllers.docexpController.removeListener(_checkForChanges);
                        ...
                        child: TextButton(
                            onPressed: () {
                              ProjectDialogs.showDeleteConfirmationSheet(
                                ...
                                onPressed: () {
                                  isDelete = true;
                                  context.read<UsersDataCubit>().deleteUserdata(
                                      id: widget.usersModel.id ?? 0);
                                },
                              );
                            },
                            child: Row(
                              ...
                              children: [
                                SizedBox(
                                    width: 20,
                                    height: 20,
                                    child: Image.asset(ProjectAssets.deleteIcon)),
                                context.szBoxWidth8,
                                Text(
                                  "delete_info".tr(),
                                  style: context.textTheme.bodyMedium
                        ...
                        child: ElevatedButton(
                          onPressed: (hasChanges && validateForm() == null)
                              ? () {
                                  ...
                                  context.read<UsersDataCubit>().updateUserdata(
                                    params: {
                                      "firstname": controllers
                                          .firstnameController.text
                                          .trim(),
                                      "lastname": controllers
                                      ...
                                      "docnum": controllers.docnumController.text
                                          .trim(),
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            disabledBackgroundColor:
                                ProjectTheme.brandColor.withAlpha(60),
